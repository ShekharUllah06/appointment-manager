...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                <p>You are now in the administrator section. This is the dashboard and nothing works but you are logged-in as an admin <i class="fa fa-smile-o fa"></i>. Once you are done looking around, you can <a href="{{ url('/logout') }}"
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="text-right">
                            <a href="{{ url('/admin/blank') }}">View Details <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="text-right">
                            <a href="{{ url('/admin/blank') }}">View All Activity <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
