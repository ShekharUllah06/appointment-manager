  ...
  /**
    ...
    protected function viewSearchPage(Request $request, $pageNo = NULL, $forwardspecialty = NULL, $forwardDistrict = NULL, $forwardThana = NULL, $forwardArea = NULL)
    {
        ...
        foreach($doctorListGrouped as $doctorQueryOrganised){
            ...
            $doctor['chamber_id'] = $doctorQueryOrganised[$count]['chamber_id'];
            $doctor['chamber_name'] = $doctorQueryOrganised[$count]['chamber_name'];
    ...
    /**
     * This function checks for spetialty data is unique,
     * else get next data to check and then assamble
