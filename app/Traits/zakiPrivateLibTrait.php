...
trait zakiPrivateLibTrait{
    ...
    private function compareDateTime($a, $b){
      //if called from scheduleController class
      ...
      return ($a["timeStamp"] > $b["timeStamp"]) ? +1 : -1;
        ...
        //if called from doctorAppointmentController->myAppointments()
